...
def create_enhancement_model_and_configs(model_name, DEVICE = "cuda"):
    ...
    if model_name == "gagnet":
        config_path = "./recipes/models/gagnet.json"
...
class Enhancemet_gagnet_train(nn.Module):
    ...
    def __init__(self,
        ...
        super(Enhancemet_gagnet_train, self).__init__()
